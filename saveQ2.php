<?php
    ...
    $sql = "UPDATE Statement_tbl SET StatementQ2='$par2', LastSaved=now(), StatementStatus='ongoing' WHERE StatementID='$statementID';";
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form id="goToFirstPage" action="creating_ps_page_q3.php" method="POST">
