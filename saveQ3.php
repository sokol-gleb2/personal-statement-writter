<?php
    ...
    $sql = "UPDATE Statement_tbl SET StatementQ3='$par3', LastSaved=now(), StatementStatus='ongoing' WHERE StatementID='$statementID';";
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form id="goToFirstPage" action="creating_ps_page_q4.php" method="POST">
