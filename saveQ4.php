<?php
    ...
    $sql = "UPDATE Statement_tbl SET StatementQ4='$par4', LastSaved=now(), StatementStatus='ongoing' WHERE StatementID='$statementID';";
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form id="goToFirstPage" action="creating_ps_page_q5.php" method="POST">
