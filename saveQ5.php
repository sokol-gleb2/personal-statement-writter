<?php
    ...
    $sql = "UPDATE Statement_tbl SET StatementQ5='$par5', LastSaved=now(), StatementStatus='ongoing' WHERE StatementID='$statementID';";
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form id="goToFirstPage" action="creating_ps_page_q6.php" method="POST">
